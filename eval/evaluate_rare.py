...
def reset_rare_summary():
    summary_rare_rows.clear()
...
def drop_output_excluded_columns(df):
    return df.drop(columns=[col for col in OUTPUT_EXCLUDED_COLUMNS if col in df.columns])
